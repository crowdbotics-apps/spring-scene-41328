"""
Django settings for spring_scene_41328 project.
...
ROOT_URLCONF = 'spring_scene_41328.urls'
...
WSGI_APPLICATION = 'spring_scene_41328.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_scene_41328 API",
    "DESCRIPTION": "API documentation for spring_scene_41328 App",
    "VERSION": "v1",
}
